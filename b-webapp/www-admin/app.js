...
.run(function(UserService, $rootScope, $state, $log){
  ...
  $rootScope.$on('$stateChangeStart',  function(event, toState, toParams, fromState, fromParams, options){
    ...
    // console.log('$stateChangeStart access: authorized - %s, allowed - %s, login - %s', AuthService.isAuthorized(), isAllowed, isLoginState);
...
.factory('bearerAuthIntercepter', function($rootScope){
    return {
        request: function(config) {
            ...
            // $rootScope._tokenInfo is set in AuthService
